      ...
      <div class="row">
        <div class="col-12">
          <table style="border-collapse: collapse; width: 100%;">
            <tr style="background-color: #33b935ff;">
            ...
            <tr>
              ...
              <td style="border: 1px solid black; padding: 8px;">TV</td>
          ...
          <br>
          <table style="border-collapse: collapse; width: 100%;">
            <tr style="background-color: #1186f4ff;">
            ...
            <tr>
              <td style="border: 1px solid black; padding: 8px;">Agus</td>
              <td style="border: 1px solid black; padding: 8px;">agus001@gmail.com</td>
              <td style="border: 1px solid black; padding: 8px;">TV</td>
              <td style="border: 1px solid black; padding: 8px;">20</td>
            </tr>
          </table>
